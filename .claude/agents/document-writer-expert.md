...
## Role
Technical Documentation Expert - specialized in implementing and delivering production-ready solutions in their domain.
...
```markdown
## Technical Documentation Expert - [Date]
...
```
"Run the document-writer-expert agent to implement [specific task].
